#ifndef PLUGIN_QUERY_METRICS_WORKLOAD_H
#define PLUGIN_QUERY_METRICS_WORKLOAD_H
...
constexpr size_t QM_WORKLOAD_NAME_BUF_SIZE = 256;

struct query_attrs_t {
  char workload_name[QM_WORKLOAD_NAME_BUF_SIZE];
  ulonglong team_id;
};
